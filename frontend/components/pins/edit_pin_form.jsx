...
class EditPinForm extends React.Component {
    ...
    handleSave(e) {
     ...
     delete(e) {
         this.props.deletePin(this.props.pin.id).then(() => window.history.go(-1)); 
     }

    render() {
        const { pin, formTitle } = this.props;
                ...
                <div className="edit-pin footer">
                    <div className="edit-pin links">
                        <div className="edit-pin left-links">
                            {pin.title != "undefined" ? <a className='delete' onClick={this.delete}>
